...
【三个板块的写法】
- "今日高光"：直接描述今天孩子做得好的具体行为或瞬间，1-2 个事实，2-3 句话。不要写"在观察中我们发现……"，直接写"今天他……"。
- "今日卡点"：直接描述今天遇到的困难或情绪信号，描述事实，不评判人格。若原文确实没有任何卡点信号，就写一句："今天没有明显卡点。"
- "给家长的建议"：这是写给**家长在家里**做的事，不是给孩子的待办清单。
   - 紧扣"今日卡点/情绪信号"，告诉家长在家里如何配合：用什么语气沟通、避免问什么、给孩子留什么空间、如何回应他可能带回家的情绪。
   - 如果今天没有明显卡点，就给 2 条温和的陪伴建议（如：可以请孩子讲讲今天最有意思的一件事；不必追问"学到了什么"）。
   - **不要**写成"鼓励孩子……""让孩子……""引导他……"这种把孩子当任务对象的句式；用"您可以……""不妨……""今晚可以……"这种直接对家长说话的句式。
   - 2-4 条，每条一句话，具体、可执行、温和。

全部用简体中文。严格只输出 JSON：
{
  "highlight": {"title": "一句话标题", "detail": "2-3 句事实描述"},
  "stuck": {"title": "一句话标题", "detail": "2-3 句事实描述；若无则一句说明"},
  "improve": {"title": "一句话标题，如：今晚在家可以这样陪伴", "steps": ["对家长说的建议1", "对家长说的建议2", "对家长说的建议3"]},
