...
【三个板块的写法】
- "今日高光"：直接描述今天孩子做得好的具体行为或瞬间，用 2-3 个短点呈现，每点一句话，只写事实，不概括评价。不要写"在观察中我们发现……"，直接写"今天他……"。同时给出一个六维能力评分（1–5 分，整数或一位小数都可），维度为：主动性、协作、创造力、同理心、表达、韧性。评分必须以"今日原始观察记录"中可观察到的行为为依据：原文中有明显正向证据的维度给 4–5；原文未涉及或证据不足的维度给 3（中性，不奖励也不惩罚）；原文中出现明显困难或回避的维度给 2。不要全部给 5。
...
全部用简体中文。严格只输出 JSON：
{
  "highlight": {
    "title": "一句话标题",
    "points": ["今天他……", "今天他……"],
    "radar": {"主动性": 4, "协作": 3, "创造力": 5, "同理心": 3, "韧性": 4, "表达": 3}
  },
